...
import { confirm, intro, isCancel, log as log2, outro, select, text } from "@clack/prompts";
  ...
  if (dev_vars_exists) {
    ...
    if (existing_secret?.length === 64) {
      ...
      const confirmed = await confirm({
        message: `Do you want to rerun ${chalk5.yellow("wrangler secret put")} just in case?`,
        initialValue: false
      });
      if (isCancel(confirmed)) throw new Error(`Cancelled.`);
      do_upload = confirmed;
